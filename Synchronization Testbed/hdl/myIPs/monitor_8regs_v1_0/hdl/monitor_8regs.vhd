-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_8regs\monitor_8regs.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_8regs
-- Source Path: monitor_8regs
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF monitor_8regs IS

  -- Component Declarations
  COMPONENT monitor_8regs_reset_sync
  ...
  COMPONENT monitor_8regs_axi_lite
  ...
  FOR ALL : monitor_8regs_reset_sync
    USE ENTITY work.monitor_8regs_reset_sync(rtl);

  FOR ALL : monitor_8regs_axi_lite
    USE ENTITY work.monitor_8regs_axi_lite(rtl);

  FOR ALL : monitor_8regs_dut
    USE ENTITY work.monitor_8regs_dut(rtl);
...
BEGIN
  u_monitor_8regs_reset_sync_inst : monitor_8regs_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_monitor_8regs_axi_lite_inst : monitor_8regs_axi_lite
  ...
  u_monitor_8regs_dut_inst : monitor_8regs_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= unsigned'(X"8FC7E13F");
