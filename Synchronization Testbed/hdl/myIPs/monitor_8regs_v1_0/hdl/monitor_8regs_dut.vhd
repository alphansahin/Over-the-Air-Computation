-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_8regs\monitor_8regs_dut.vhd
...
END monitor_8regs_dut;


ARCHITECTURE rtl OF monitor_8regs_dut IS

  -- Component Declarations
  COMPONENT monitor_8regs_src_monitor_8regs_dut
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : monitor_8regs_src_monitor_8regs_dut
    USE ENTITY work.monitor_8regs_src_monitor_8regs_dut(rtl);
...
BEGIN
  u_monitor_8regs_src_monitor_8regs_dut : monitor_8regs_src_monitor_8regs_dut
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
