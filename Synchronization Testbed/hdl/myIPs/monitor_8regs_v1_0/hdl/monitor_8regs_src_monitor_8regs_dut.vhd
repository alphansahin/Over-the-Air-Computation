-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_8regs\monitor_8regs_src_monitor_8regs_dut.vhd
-- Created: 2024-12-24 12:15:27
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_8regs_src_monitor_8regs_dut
-- Source Path: monitor_8regs/monitor_8regs_dut
-- Hierarchy Level: 0
-- Model version: 5.2
-- 
-- -------------------------------------------------------------
...
ENTITY monitor_8regs_src_monitor_8regs_dut IS
...
END monitor_8regs_src_monitor_8regs_dut;


ARCHITECTURE rtl OF monitor_8regs_src_monitor_8regs_dut IS

  -- Component Declarations
  COMPONENT monitor_8regs_src_MATLAB_Function
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataWriteAXI0                   :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : monitor_8regs_src_MATLAB_Function
    USE ENTITY work.monitor_8regs_src_MATLAB_Function(rtl);
...
BEGIN
  u_MATLAB_Function : monitor_8regs_src_MATLAB_Function
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
