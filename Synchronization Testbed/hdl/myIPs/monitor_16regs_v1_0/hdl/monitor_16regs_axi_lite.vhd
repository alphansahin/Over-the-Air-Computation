-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_16regs\monitor_16regs_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_16regs_axi_lite
-- Source Path: monitor_16regs/monitor_16regs_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY monitor_16regs_axi_lite IS
...
END monitor_16regs_axi_lite;


ARCHITECTURE rtl OF monitor_16regs_axi_lite IS

  -- Component Declarations
  COMPONENT monitor_16regs_addr_decoder
  ...
  COMPONENT monitor_16regs_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : monitor_16regs_addr_decoder
    USE ENTITY work.monitor_16regs_addr_decoder(rtl);

  FOR ALL : monitor_16regs_axi_lite_module
    USE ENTITY work.monitor_16regs_axi_lite_module(rtl);
...
BEGIN
  u_monitor_16regs_addr_decoder_inst : monitor_16regs_addr_decoder
  ...
  u_monitor_16regs_axi_lite_module_inst : monitor_16regs_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
