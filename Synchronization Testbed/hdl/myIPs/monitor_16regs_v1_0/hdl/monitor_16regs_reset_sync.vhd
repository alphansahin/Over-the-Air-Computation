-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_16regs\monitor_16regs_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_16regs_reset_sync
-- Source Path: monitor_16regs/monitor_16regs_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY monitor_16regs_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END monitor_16regs_reset_sync;


ARCHITECTURE rtl OF monitor_16regs_reset_sync IS
