-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_72regs_2023b\monitor_72regs_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_72regs_axi_lite_module
-- Source Path: monitor_72regs/monitor_72regs_axi_lite/monitor_72regs_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY monitor_72regs_axi_lite_module IS
...
END monitor_72regs_axi_lite_module;


ARCHITECTURE rtl OF monitor_72regs_axi_lite_module IS
  ...
  SIGNAL reg_ar_transfer_del_reg          : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
  ...
  SIGNAL reg_rvalid_int_reg               : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
...
BEGIN
  ...
  reg_ar_transfer_del_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      reg_ar_transfer_del_reg <= (OTHERS => '0');
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        reg_ar_transfer_del_reg(0) <= ar_transfer;
        reg_ar_transfer_del_reg(1) <= reg_ar_transfer_del_reg(0);
      END IF;
    END IF;
  END PROCESS reg_ar_transfer_del_process;

  ar_transfer_del <= reg_ar_transfer_del_reg(1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND ar_transfer_del = '1' THEN
  ...
  reg_rvalid_int_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      reg_rvalid_int_reg <= (OTHERS => '0');
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        reg_rvalid_int_reg(0) <= rvalid_int;
        reg_rvalid_int_reg(1) <= reg_rvalid_int_reg(0);
      END IF;
    END IF;
  END PROCESS reg_rvalid_int_process;

  AXI4_Lite_RVALID <= reg_rvalid_int_reg(1);
