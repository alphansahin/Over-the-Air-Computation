-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\monitor_64regs_2023b\monitor_64regs_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: monitor_64regs_reset_sync
-- Source Path: monitor_64regs/monitor_64regs_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY monitor_64regs_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END monitor_64regs_reset_sync;


ARCHITECTURE rtl OF monitor_64regs_reset_sync IS
